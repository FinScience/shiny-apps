...
## Getting the data for the websites         
        ...
        getDataset <- reactive({
                switch(input$page,
                       "Bastei.de" = alexaTrafficRank[,2],
                       "Bastei Luebbe Academy" = alexaTrafficRank[,3],
                       "Beam Ebooks" = alexaTrafficRank[,4],
                       "Bookrix" = alexaTrafficRank[,5],
                       "Daedalic" = alexaTrafficRank[,6],
                       "PMV Raetsel" = alexaTrafficRank[,7],
                       "Praesenta.de" = alexaTrafficRank[,8],
                       "Raeder.de" = alexaTrafficRank[,9])
